...
<body>
	...
	<ul id = "menu">
		...
		<li><a href = "login.php">Make a reservation</a></li> |
	...
	<div id="myCarousel" class="carousel slide container-fluid" data-ride="carousel">
		...
		<div style = "margin:auto;" class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/background.jpg" style = "width:100%; height:450px;" />
			</div>
		
			<div class="item">
				<img src="images/picture5.jpg" style = "width:100%; height:450px;"  />
			</div>
